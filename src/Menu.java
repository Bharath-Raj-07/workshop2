        ...
        while(entry!=0) {
            ...
            switch (entry) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Enter City name to search for Persons");
                    books.searchCity(sc.next());
                    break;
                case 5:
                    System.out.println("Enter State name to Search for Persons");
                    books.searchState(sc.next());
